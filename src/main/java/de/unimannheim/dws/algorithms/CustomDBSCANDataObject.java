...
public class CustomDBSCANDataObject 
	implements DataObject, Serializable, RevisionHandler {
	     ...
	     */
	    public CustomDBSCANDataObject(Instance originalInstance, String key, Database database) {
	        ...
	        de.unimannheim.dws.algorithms.ClusterGrouper.retrieve();
	    }
